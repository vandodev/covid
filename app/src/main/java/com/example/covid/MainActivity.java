...
public class MainActivity extends AppCompatActivity {
        TextView tvCases, tvRecovered,tvCritical,tvActive,tvTodayCases,tvTotalDeaths,tvTodayDeaths,tvAffectedConuntries;
        ...
        StringRequest request = new StringRequest(Request.Method.GET, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    tvAffectedConuntries.setText(jsonObject.getString("affectedCountries"));
                    ...
                    scrollCiew.setVisibility(View.VISIBLE);
